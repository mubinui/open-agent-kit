...
export const ToolNode = memo(({ data, selected }: NodeProps<Node<WorkflowNodeData>>) => {
    ...
    return (
        <div
            className={`group relative flex min-w-[190px] max-w-[250px] items-center gap-2.5 rounded-lg border px-3 py-2.5 ag-surface-raised shadow-sm transition-all duration-200
            ${liveClass || (selected
        ...
        >
            ...
            <Handle
                ...
                className="!w-2.5 !h-2.5 !-left-1.5 !bg-gray-400 !border-2 !border-[var(--color-surface-raised)] group-hover:!bg-orange-500 transition-colors"
            />

            {/* Icon */}
            <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border border-orange-100 bg-orange-50 text-orange-600">
            ...
            <Handle
                ...
                className="!w-2.5 !h-2.5 !-right-1.5 !bg-gray-400 !border-2 !border-[var(--color-surface-raised)] group-hover:!bg-orange-500 transition-colors"
            />
        </div>
    );
});
